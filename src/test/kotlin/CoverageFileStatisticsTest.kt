...
class CoverageFileSatisticsTest {
    ...
    fun `valid file with coverage in package`() {
        ...
        """.trimIndent().byteInputStream(), "com.mypackage")
    ...
    fun `totally invalid file`() {
        val result = CoverageFileVerifier.verify("invalid file content".byteInputStream(), "com.mypackage")
